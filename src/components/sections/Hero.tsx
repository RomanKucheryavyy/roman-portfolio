...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* CSS volumetric spotlight beams */}
      <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
        {SPOTLIGHTS.map((beam, i) => (
          <div
            key={i}
      ...
      >
        <h1 className="font-display font-black text-5xl sm:text-7xl md:text-8xl lg:text-[9rem] leading-[1] pb-[0.15em] overflow-visible">
          <div
            ref={firstNameRef}
